    ...
    <div className="snap-container">
      ...
      <section className="snap-item flex flex-col items-center justify-center bg-gray-900 text-white p-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center">
          ...
          <p className="text-lg text-gray-300 leading-relaxed max-w-3xl">
            ...
            <br />
            <br />
            **Prayer is not just an event—it’s a lifestyle.** It shapes our hearts, strengthens our faith, and keeps us aligned with God’s will.
          </p>
        </div>
      </section>
      ...
      <section className="snap-item flex flex-col items-center justify-center bg-gray-900 text-white p-10">
        <div className="max-w-3xl text-center">
          ...
          <ul className="list-disc pl-8 text-gray-300 leading-loose text-left">
            <li>How can you **pray without ceasing** in your daily life?</li>
