...
export default function Lesson1() {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <h1 className="text-4xl font-bold text-center mb-6 text-gray-800">Lesson 1: Jesus&apos; Prayer for Peter & The Refining Fire</h1>
      ...
      <div className="flex justify-center my-6">
        <video className="rounded-lg shadow-md" width="600" controls>
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg">
        <h2 className="text-2xl font-bold text-center text-gray-800">Reflection Questions</h2>
